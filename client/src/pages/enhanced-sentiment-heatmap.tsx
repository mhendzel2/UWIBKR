...
export default function EnhancedSentimentHeatmap() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Enhanced Market Sentiment & Intelligence</h1>
